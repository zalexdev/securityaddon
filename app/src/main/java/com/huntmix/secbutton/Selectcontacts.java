...
public class Selectcontacts extends Activity {
    ...
    public void contacts(){
        new MultiContactPicker.Builder(Selectcontacts.this)
                .theme(R.style.MultiContactPicker_Azure)
                .hideScrollbar(false)
                .showTrack(true)
                .searchIconColor(Color.WHITE)
                .setChoiceMode(MultiContactPicker.CHOICE_MODE_MULTIPLE)
                .handleColor(ContextCompat.getColor(Selectcontacts.this, R.color.colorPrimary))
                .bubbleColor(ContextCompat.getColor(Selectcontacts.this, R.color.colorPrimary))
                ...
                if(results.size() > 0) {
                    for (int i = 0; i<results.size();i++){
                        ...
                        for (int i2 = 0;i2<num.size();i2++){
                            ...
                            tinydb.putListString("list5",nums);
                        }}
                }
